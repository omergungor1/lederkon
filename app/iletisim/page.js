        ...
        <div className="grid gap-12 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-6 text-[#D1D5DB]">
              Lederkon, Bursa merkezli bir LED ekran montaj ve proje firmasıdır. Yılların getirdiği tecrübe ile Bursa ve Türkiye genelinde düğün salonu, AVM, cami, mağaza ve kurumsal projelerde güvenilir çözümler sunuyoruz. LED ekran fiyatı, teknik danışmanlık veya proje talepleriniz için bize ulaşabilirsiniz; tüm soru, görüş ve önerilerinizi dinlemek için buradayız.
            </p>
          </div>
