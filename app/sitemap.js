...
import { getAllCozumSlugs } from "@/lib/cozumler";
...
export default function sitemap() {
  const base = [
    ...
    { url: `${SITE_URL}/cozumler`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.85 },
  ...
  const cozumler = getAllCozumSlugs().map((slug) => ({
    url: `${SITE_URL}/cozumler/${slug}`,
  ...
  return [...base, ...cozumler, ...urunler, ...blog];
}
