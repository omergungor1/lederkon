  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <p className="mt-4 max-w-3xl text-lg text-[#D1D5DB]">
        Kapalı (indoor) ve açık alan (outdoor) LED ekran çözümleri, kiralık (rental) sistemler ve özel uygulamalar.
        Türkiye genelinde keşif, montaj, devreye alma ve teknik servis hizmeti veriyoruz.
      </p>
      ...
      <section className="mt-10 grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-xl border border-white/10 bg-[#111827] p-6">
          ...
          <p className="mt-3 text-xs text-[#B9FF00]">
            Not: IP sınıfı, kurulum konumu ve hava koşullarına göre proje bazında doğrulanır.
          </p>
        </div>
        <div className="rounded-xl border border-white/10 bg-[#111827] p-6">
